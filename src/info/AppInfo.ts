...
export const fullProvinces: Province[] = [
    {
...
export const policies = [
    'JobFinder không cho phép một người dùng tạo nhiều tài khoản khác nhau.\n' +
    ' Nếu phát hiện vi phạm, JobFinder sẽ ngừng cung cấp dịch vụ ' +
    'tới tất cả các tài khoản trùng lặp hoặc chặn toàn bộ truy cập tới hệ thống website của JobFinder. \n',
    'Khi chúng tôi phát hiện trường hợp có hành vi quấy rối hoặc vi phạm pháp luật hoặc quy chuẩn đạo đức, JobFinder sẽ cấm tài khoản vĩnh viễn.',
    'Nhà tuyển dụng có 15 lần đăng bài mỗi tháng, nếu có nhu cầu nhiều hơn, vui lòng liên hệ quản trị viên: '
]
