...
import {Collapse, CollapseProps, DatePicker, Form, GetProps, Input, InputNumber, Select, TimePicker} from "antd";
import {
    MdAccessTimeFilled,
    MdAttachMoney,
    MdDescription,
...
const AddJob = () => {
    ...
    return (
        <div className={`flex w-full   relative mt-10 overflow-y-visible `}>
            <Form
