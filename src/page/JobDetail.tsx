                        ...
                        <div className={`flex items-center flex-col gap-6 sticky top-0`}>
                            ...
                            <div
                                ...
                                <div className={`flex flex-col w-full *:mb-3`}>
                                        ...
                                        <div className={`flex cursor-pointer gap-4 items-start`}>
                                            <div
                                                ...
                                                <img src="https://www.topcv.vn/v4/image/normal-company/logo_default.png"
                                                     alt="công ty TNHH nhập khẩu và phân phối Greenhome"
                                                     className="flex items-center object-contain aspect-square w-[73.92px] flex-shrink-0 rounded-[5px] max-w-full"/>
                                            </div>
                                            <h2 className={`font-bold  w-[calc(100%-100px)]`}>công ty TNHH nhập khẩu và
                                                phân
                                                phối Greenhome</h2>
                                        </div>
                                    </a>
                                    {/*company size*/}
                                    <div className={`flex gap-4 items-start *:w-[88px] *:leading-6 *:text-[#7f878f]`}>
                                    ...
                                    <div className={`flex gap-4 items-start *:w-[88px] *:leading-6 *:text-[#7f878f]`}>
                                        ...
                                        <div className={`!text-[#212f3f] font-[500] !w-[calc(100%-100px)]`}>
                                            số 11, ngõ 131 chu huy mân, phúc đồng, long biên
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div className={`flex gap-4 items-center `}>
                                    ...
                                    <div className={`flex flex-col `}>
                                        <p>Số lượng</p>
                                        <p className={`font-bold`}>1 người</p>
                                    </div>
                                </div>
                                {/*type*/}
                                <div className={`flex gap-4 items-center `}>
                                ...
                                <div className={`flex gap-4 items-center `}>
                                    ...
                                    <div className={`flex flex-col `}>
                                        <p>Giới tình </p>
                                        <p className={`font-bold`}>Không yêu cầu</p>
                                    </div>
                                </div>
                            </div>
                        </div>
